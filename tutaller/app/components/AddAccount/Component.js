  ...
  methods: {
    createAccount() {
      if (this.validateFormCreateAccount()) {
        ...
        const data = { user_rut: deformatRutNumber(this.rutInput.trim()), user_name: this.nameInput.trim(), user_last_name: this.lastNameInput.trim(), user_email: this.emailInput.trim(), user_phone: this.phoneInput.trim(), user_password: this.passwordInput, user_status: 'enabled' }
